...
| D9 | Observer MVP | Único observer activo: Share Extension iOS. Desktop no observa en MVP. | Es el mínimo necesario para el caso dorado. FS Watcher entra en Fase 1. |
...
| D11 | Plataforma | macOS + iOS first. | Encaja con iCloud, APIs maduras y target inicial. |
